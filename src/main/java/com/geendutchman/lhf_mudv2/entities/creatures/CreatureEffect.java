...
@AutoValue
public abstract class CreatureEffect implements Examinable, Serializable {

    protected CreatureEffect() {
    }

    public abstract ImmutableList<Creature.Delta> deltas();
    ...
    final static Taggable.Tag CREATURE_EFFECT_TAG = new Taggable.Tag("CREATURE_EFFECT");

    @Override
    public final Tag tag() {
        return CREATURE_EFFECT_TAG;
    }

    public static Builder builder() {
        return new AutoValue_CreatureEffect.Builder();
    }
    ...
    public abstract static class Builder {
        ...
        abstract ImmutableList.Builder<Creature.Delta> deltasBuilder();
        ...
        public abstract CreatureEffect build();
